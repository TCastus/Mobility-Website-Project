...
urlpatterns = [
    ...
    path(
        ...
        views.editDepartmentStudent,
        name="edit-department-student",
    ),
    path(
        "edit-exchange/<int:univ>/<int:stud>", views.editExchange, name="edit-exchange"
    ),
    path(
        "edit-financial/<int:univ>/<int:exch>",
        views.editFinancial,
        name="edit-financial",
    ),
